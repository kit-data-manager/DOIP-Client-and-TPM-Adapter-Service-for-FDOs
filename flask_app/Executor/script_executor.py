...
class Script_Executor(Generic_Executor):
    ...
    def stage_ep(execution_protocol, pits):
        ...
        Script_Executor.manage_installation_requirements(installations)
